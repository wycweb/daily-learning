...
// * MapReduce单词统计
// */
//public class CombineWordCountApp {
//
//    /**
...
//
//        //step2:获取job相关信息
//        job.setJarByClass(CombineWordCountApp.class);
//
...
//
//
//        //当map读取很多哥小文件的时候，默认也会按照小文件的数量来生成task任务
//        //默认走的是TextInputFormat
////        job.setInputFormatClass(CombineTextInputFormat.class);
//        job.setInputFormatClass(NLineInputFormat.class);
//        NLineInputFormat.setNumLinesPerSplit(job,10000);
//        CombineTextInputFormat.setMaxInputSplitSize(job, 4194304);//这个只能和文本
//        //当我们使用CombineTextInputFormat 设置每一块的最大值
//        // split切分的数量计算
//        /**
//         * 我们设置 MaxInputSplitSize为 4M
//         *
//         * 假设我们现在读取4个文件，四个文件的大小为1.4M 4.2M 2.8M 5.7M
//         * 我们设置 MaxInputSplitSize为 4M后
//         * 1.4M 小于 4M，拆一个文件 拆成1.4M
//         * 4.2M 大于4M小于 2*4M拆两个文件 2.1 2.1
//         * 2.8M 小于 4M ，拆一个2.8
//         * 5.7M 大于4M小于 2*4 拆两个文件 2.85 2.85
//         *
//         * 1.4 <4   拆一个    1.4
//         * 4.2 >4 <2*4 拆两个 2.1 2.1
//         * 2.8 <4   拆一个    2.8
//         * 5.7 >4 < 8 拆两个 2.85 2.85
//         *
//         * 拆完之后，会把 1.4 和 2.1弄成一块
//         */
//
//
//        /**
